      ...
      <div className=" h-full flex flex-col justify-center gap-10 sm:flex-row-reverse sm:items-center">
        ...
        <div className="w-full">
          <div className="w-full flex flex-col gap-4">
            <h1 className=" text-primary font-bold text-3xl text-center md:text-3xl md:text-start lg:text-6xl">
              Olá, Bem Vindo!
            </h1>
            <p className="text-lg text-center md:text-start lg:text-xl">
              <Balancer>
                Conheça meu trabalho como desenvolvedor web, acompanhe meus
                últimos projetos através deste web App desenvolvido por mim para
                ser o meu <strong>portfólio</strong>
              </Balancer>
            </p>
          </div>
          ...
          <div className="flex gap-5 mt-4 justify-center w-full md:justify-start">
            <Button.Root>
              <a
                href={curriculo}
                download="currículo-joao-souza.pdf"
                target="_blank"
                rel="noreferrer"
              >
